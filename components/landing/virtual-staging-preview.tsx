  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[2rem] bg-gray-100 shadow-2xl ring-1 ring-black/5">
      ...
      >
        ...
        {!isCompareMode && (
          <div className="absolute top-6 left-6 flex items-center gap-2 rounded-full bg-white/95 px-4 py-2 font-bold text-[#221E68] text-sm shadow-sm backdrop-blur-md">
      ...
      <div 
        className="absolute bottom-6 left-1/2 flex -translate-x-1/2 transform gap-1 rounded-full bg-white/90 p-1.5 shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur-xl border border-white/20 z-30 transition-opacity duration-300"
      >
