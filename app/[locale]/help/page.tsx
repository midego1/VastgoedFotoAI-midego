...
export const metadata = constructMetadata({
  title: "Help Center | VastgoedFotoAI.nl",
  description:
    "Get help with VastgoedFotoAI.nl. Browse our knowledge base for guides, tutorials, and answers to frequently asked questions.",
  canonical: "/help",
});
